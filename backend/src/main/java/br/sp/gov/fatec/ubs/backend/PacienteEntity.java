...
public class PacienteEntity {
    ...
    private LocalDate dataNascimento; // Usando LocalDate para representar data
    private String sexo;
    private String nacionalidade; // Corrigido erro de digitação
    ...
    // Adicionando o campo ficha para armazenar o nome/caminho do arquivo
    private String ficha; // Novo campo

    // Getter e Setter para o campo ficha
